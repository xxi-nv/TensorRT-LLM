...
class CutlassFusedMoE(MoEImplBase):
    ...
    def __init__(
        ...
        *,
        ...
        # slot_start, slot_end, initial_local_expert_ids are initialized by
        # apply_moe_impl_construction_state(); ConfigurableMoE then overwrites
        # them from the wrapper via _BACKEND_SYNC_ATTRS.
    ...
    # ``forward_fake`` and ``load_weights`` are inherited unchanged from the
    # shared blocks; this class had byte-identical copies of both.
