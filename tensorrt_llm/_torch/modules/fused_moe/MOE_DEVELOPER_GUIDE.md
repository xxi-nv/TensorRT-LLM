...
- Dynamic EPLB requires backend support; backends gate this via `validate_configurable_moe`. `MegaMoEDeepGemm` rejects dynamic EPLB and asserts `num_slots % ep_size == 0`.
